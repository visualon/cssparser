...
namespace UnitTests
{
	public class LessParserTests
	{
		...
		/// <summary>
		/// Previously "::before" and "::after" pseudo classes were not recognised as such, this test is to exercise the changes required to address this
		/// </summary>
		[Fact]
		...
		/// <summary>
		/// Now all double-colon pseudo classes should be recognised as such (there is no white list required), so try one that isn't in the white list
		/// </summary>
		[Fact]
